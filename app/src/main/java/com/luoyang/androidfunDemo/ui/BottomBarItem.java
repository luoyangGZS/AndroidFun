...
public class BottomBarItem extends LinearLayout {
    ...
    private void initAttrs(TypedArray ta) {
        ...
        titleTextSize = ta.getDimensionPixelSize(R.styleable.BottomBarItem_itemTextSize, Utils.sp2px(context, titleTextSize));

        titleNormalColor = ta.getColor(R.styleable.BottomBarItem_textColorNormal, Utils.getColor(context, R.color.base_tab_normal_color));
        titleSelectedColor = ta.getColor(R.styleable.BottomBarItem_textColorSelected, Utils.getColor(context, R.color.base_tab_selected_color));

        marginTop = ta.getDimensionPixelSize(R.styleable.BottomBarItem_itemMarginTop, Utils.dip2Px(context, marginTop));
        ...
        unreadTextSize = ta.getDimensionPixelSize(R.styleable.BottomBarItem_unreadTextSize, Utils.sp2px(context, unreadTextSize));
        unreadTextColor = ta.getColor(R.styleable.BottomBarItem_unreadTextColor, Utils.getColor(context, R.color.base_common_white));
        unreadTextBg = ta.getDrawable(R.styleable.BottomBarItem_unreadTextBg);

        msgTextSize = ta.getDimensionPixelSize(R.styleable.BottomBarItem_msgTextSize, Utils.sp2px(context, msgTextSize));
        msgTextColor = ta.getColor(R.styleable.BottomBarItem_msgTextColor, Utils.getColor(context, R.color.base_common_white));
    ...
    private void checkValues() {
        ...
        if (unreadTextBg == null) {
            unreadTextBg = getResources().getDrawable(R.drawable.base_shape_unread);
        }

        if (msgTextBg == null) {
            msgTextBg = getResources().getDrawable(R.drawable.base_shape_msg);
        }

        if (notifyPointBg == null) {
            notifyPointBg = getResources().getDrawable(R.drawable.base_shape_notify_point);
        }
    }
    ...
    private View initView() {
        View view = View.inflate(context, R.layout.base_item_bottom_bar, null);
        if (itemPadding != 0) {
            //如果有设置item的padding
    ...
    public void setNormalIcon(int resId) {
        setNormalIcon(Utils.getDrawable(context, resId));
    }
    ...
    public void setSelectedIcon(int resId) {
        setSelectedIcon(Utils.getDrawable(context, resId));
    }
    ...
    public static final class Builder {
        ...
        public Builder(Context context) {
            this.context = context;
            titleTextBold = false;
            titleTextSize = Utils.sp2px(context, 12);
            titleNormalColor = getColor(R.color.base_tab_text);
            titleSelectedColor = getColor(R.color.base_common_red);
            unreadTextSize = Utils.sp2px(context, 10);
            msgTextSize = Utils.sp2px(context, 6);
            unreadTextColor = getColor(R.color.base_common_white);
            unreadNumThreshold = 99;
            msgTextColor = getColor(R.color.base_common_white);
        }
        ...
        public Builder titleTextSize(int titleTextSize) {
            this.titleTextSize = Utils.sp2px(context, titleTextSize);
            return this;
        }
        ...
        public Builder unreadTextSize(int unreadTextSize) {
            this.unreadTextSize = Utils.sp2px(context, unreadTextSize);
            return this;
        }
        ...
        public Builder msgTextSize(int msgTextSize) {
            this.msgTextSize = Utils.sp2px(context, msgTextSize);
            return this;
        }
        ...
        public BottomBarItem create(int normalIconId, int selectedIconId, String text) {
            return create(Utils.getDrawable(context, normalIconId), Utils.getDrawable(context, selectedIconId), text);
        }
